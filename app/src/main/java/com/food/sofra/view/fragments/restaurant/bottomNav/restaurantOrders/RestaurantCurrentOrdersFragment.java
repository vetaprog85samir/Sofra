...
import com.food.sofra.adapter.RestaurantCurrentOrderAdapter;
...
public class RestaurantCurrentOrdersFragment extends BaseFragment {


    Unbinder unbinder;
    @BindView(R.id.fragment_restaurant_current_orders_rv)
    RecyclerView fragmentRestaurantCurrentOrdersRv;
    private LinearLayoutManager linearLayoutManager;
    private OnEndLess onEndLess;
    private int maxPage=0;
    private RestaurantCurrentOrderAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_restaurant_current_orders, container, false);
    ...
    private void init() {
        ...
        fragmentRestaurantCurrentOrdersRv.setLayoutManager(linearLayoutManager);
            ...
            public void onLoadMore(int current_page) {
                ...
                if (current_page <= maxPage) {
                    if (maxPage != 0 && current_page != 1) {
                        ...
                        getRestaurantCurrentOrders(current_page);
                    } else {
        ...
        fragmentRestaurantCurrentOrdersRv.addOnScrollListener(onEndLess);

        adapter = new RestaurantCurrentOrderAdapter(getActivity(),getActivity()
                ,restaurantMyOrdersData);
        fragmentRestaurantCurrentOrdersRv.setAdapter(adapter);

        getRestaurantCurrentOrders(1);
    }

    private void getRestaurantCurrentOrders(int page) {
        getClient().restaurantMyOrders(SharedPreferencesManger.loadData(getActivity(),"api_token"),"current", page).enqueue(new Callback<RestaurantMyOrders>() {
            @Override
