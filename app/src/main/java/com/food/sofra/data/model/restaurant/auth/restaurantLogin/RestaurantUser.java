...
public class RestaurantUser {
    ...
    @Expose
    private List<RestaurantNewCategoryData> categories = null;
    ...
    public List<RestaurantNewCategoryData> getCategories() {
        return categories;
    }

    public void setCategories(List<RestaurantNewCategoryData> categories) {
